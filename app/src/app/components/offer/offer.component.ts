...
onRadioChange(event:any){
   this.timeSlotSelected= event.target.id;
    ...
    const loginObject:LoginObject = JSON.parse(localStorage.getItem('login-object'))
    const userId:number = loginObject.userId;
    const offerRide:OfferRide = {startpoint:startPoint, endPoint:endPoint,date:date,price:price,timeSlot:this.timeSlotSelected,stops:stops,seats:seats,userName: username,userId:userId};
